...
<link type="text/css" href="./topjui/themes/default/topjui.black.css" rel="stylesheet" id="dynamicTheme"/>
<!-- FontAwesome字体图标 -->
...
<body>
    ...
    <div data-toggle="topjui-layout" data-options="id:'index_layout',fit:true">
	    <div id="north" class="banner" data-options="region:'north',border:false,split:false"
	        ...
	        <table style="float:left;border-spacing:0px;">
	            <tr>
	                <td class="webname">
	                    <span class="fa fa-envira" style="font-size:26px; padding-right:8px;"></span>魅力济南-在旅途
	                </td>
	                ...
	                <td>
	                    <table id="topmenucontent" cellpadding="0" cellspacing="0">
	                        <td id="1325" title="魅力济南行后台管理系统" class="topmenu selected systemName">
	                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
	                                <p>
	                                    <lable class="fa fa-hand-pointer-o"></lable>
	                                </p>
	                                <p><span style="white-space:nowrap;">后台管理</span></p>
	                            </a>
	                        </td>
	        ...
	        <span style="float: right; padding-right: 10px; height: 50px; line-height: 50px;">
	            <span class="menuA" style="height: 50px; line-height: 50px;"><a href="javascript:void(0)" style="color:#fff;text-decoration: none;">
	               <span class="glyphicon glyphicon-user"></span> TopJUI前端框架 </a></span> |
	           
	            <a href="javascript:void(0)" onclick="logout()" style="color:#fff;text-decoration: none;" class="menuA">
	            	<span class="glyphicon glyphicon-asterisk"></span> 注销 </a>
	        </span>
	    </div>
	    ...
	    <div data-options="region:'south',border:true"
	        ...
	        <span style="padding-right:5px;width:40%">
	            版权所有 © 2018-2026
	            <a href="http://www.ewsd.cn" target="_blank">魅力济南行官网</a>
	            <a href="http://www.miitbeian.gov.cn" target="_blank">鲁ICP备 1818948</a>
	        </span>
	...
	<form id="pwdDialog" data-options="title: '修改密码', iconCls:'fa fa-key', width: 400, height: 300, href: '/html/user/modifyPassword.html'"></form>
