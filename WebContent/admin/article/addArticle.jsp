...
<body>
    <div id="p" class="easyui-panel" title="编写游记" style="padding: 10px">
	 	<table cellspacing="20px">
	   		<tr>
	   			<td width="80px">游记标题：</td>
	   		...
	   		<tr>
	   			<td></td>
	   			<td>
	   				<a href="javascript:submitData()" class="easyui-linkbutton" data-options="iconCls:'icon-submit'">发布游记</a>
	   			</td>
	   		</tr>
	   	</table>
	 </div>
