...
<body>
	...
	<script>
	    	...
	    	var productDg = {
		        ...
		        $("#productDg").iDatagrid({
		            ...
		            columns: [[
		                ...
		                {field: 'subject', title: '摘要', sortable: true},
		                {field: 'clickHit', title: '点击量', sortable: true},
		                {field: 'repleHit', title: '回复量', sortable: true},
		                {field: 'time', title: '发布时间', sortable: true},
		                {field: 'sign', title: '文章类型', sortable: true},
		        ...
		        $("#openTab").iMenubutton({
		            ...
		            tab: {
		                title: '添加游记',
		                href: _ctx + '/article/addArticle.jsp'
		            },
		            grid: productDg
		        });
		        $("#add").iMenubutton({
		        ...
		        $("#delete").iMenubutton({
		            ...
		            iconCls: 'fa fa-trash',
		            btnCls: 'topjui-btn-normal',
		            confirmMsg: '您确定要删除这条游记，删除之后无法进行恢复！',
		            grid: {
		                type: 'datagrid',
		                id: 'productDg',
		                uncheckedMsg: '请先勾选要删除的文章',
		                param: 'id:id'
		            },
	    ...
	    function filterFiled(){
	    	...
	    	for(var j = 6; j < fieldArray.length;){
	    		nameArray[k] = fieldArray[j];
	    		k ++;
	    		j += 5;
	    	}
