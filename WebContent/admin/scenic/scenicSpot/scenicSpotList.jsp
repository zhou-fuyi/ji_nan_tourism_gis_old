	    ...
	    function open(){
	        ...
	        $("#productDg").iDatagrid({
	            ...
	            columns: [[
	                ...
	                {field: 'tagline', title: '景区宣传标语', sortable: true},
	                {field: 'level', title: '景区等级', sortable: true},
	                {field: 'defaultPhoto', title: '景点大图', sortable: true},
	                {field: 'ticketPrice', title: '票价', sortable: true},
	                {field: 'intro', title: '景区简介', sortable: true},
	                {field: 'management', title: '景区管理机构', sortable: true},
	                {field: 'cName', title: '景区称号', sortable: true},
	                {field: 'feature', title: '特色景观', sortable: true},
	                {field: 'types', title: '景区类型', sortable: true},
	                {field: 'line', title: '景区游览路线', sortable: true},
	                {field: 'tel', title: '景区电话', sortable: true},
	                {field: 'guideMan', title: '景区解说员说明', sortable: true},
	                {field: 'time', title: '景区营业时间', sortable: true},
	                {field: 'supporting', title: '景区配套设施服务', sortable: true},
	                {field: 'costTime', title: '游览时间', sortable: true},
	                {field: 'website', title: '景区官网', sortable: true},
	                {field: 'serviceCenter', title: '游客服务中心', sortable: true},
	                {field: 'priceDescription', title: '票价说明', sortable: true},
	                {field: 'discount', title: '门票优惠政策', sortable: true},
	                {field: 'photos', title: '景区图片', sortable: true},
	                {field: 'bus', title: '公交路线提示', sortable: true},
	                {field: 'website', title: '景区官网', sortable: true},
	                {field: 'driving', title: '自驾车指南', sortable: true},
	                {field: 'park', title: '停车场信息', sortable: true},
	                {field: 'releaseDate', title: '景区详情发布时间', sortable: true},
	            ]],
	            filter: [{
	                field: 'name',
	                type: 'textbox',
	        ...
	        $("#add").iMenubutton({
	            ...
	            dialog: {
	                id: 'userAddDialog',
	                height: 450,
	                href: _ctx + './scenic/scenicSpot/addScenicSpot.html',
	                buttonsGroup: [
	                    {
	                        text: '保存',
	        ...
	        $("#delete").iMenubutton({
	            ...
	            iconCls: 'fa fa-trash',
	            btnCls: 'topjui-btn-normal',
	            confirmMsg: '您确定要删除选中的景点详情数据吗？删除后无法恢复！',
	            grid: {
	                type: 'datagrid',
	                id: 'productDg',
