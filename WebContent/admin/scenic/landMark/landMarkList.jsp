	    ...
	    function open(){
	        ...
	        $("#productDg").iDatagrid({
	            ...
	            columns: [[
	                ...
	                {field: 'lng', title: '景点经度', sortable: true},
	                {field: 'tel', title: '景点联系电话', sortable: true},
	                {field: 'img', title: '景点图片地址', sortable: true},
	                {field: 'subject', title: '景点介绍', sortable: true},
	            ]],
	            filter: [{
	                field: 'name',
	                type: 'textbox',
	        ...
	        $("#add").iMenubutton({
	            ...
	            dialog: {
	                id: 'userAddDialog',
	                height: 350,
	                href: _ctx + './scenic/landMark/addLandMark.html',
	                buttonsGroup: [
	                    {
	                        text: '保存',
	        ...
	        $("#delete").iMenubutton({
	            ...
	            iconCls: 'fa fa-trash',
	            btnCls: 'topjui-btn-normal',
	            confirmMsg: '您确定要删除选中的景点数据吗？删除后无法恢复！',
	            grid: {
	                type: 'datagrid',
	                id: 'productDg',
