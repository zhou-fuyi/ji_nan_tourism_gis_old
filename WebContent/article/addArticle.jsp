	...
	<script type="text/javascript">
        ...
        function submitData(){
    		...
    		if(title==null || title==''){
    			...
    			$.post("/ji_nan_tourism_gis_old/blog-addBlog.action",{'title':title,'content':content,'subject':ue.getContentTxt().substr(0,155),'keyWord':keyWord,'sign':blogTypeId},function(result){
        			console.log(result);
    				if(result == "1"){
    					alert("博客发布成功！");
    					resetValue();
