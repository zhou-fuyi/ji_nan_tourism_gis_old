...
<body class="gray-bg">
	    ...
	    <div class="row">
	        <div class="col-md-12">
	        	...
	        	<div class="data_list">
					...
					<div class="datas">
						<ul>
						  <s:iterator var="scenic" value="#session.scenicPageBean.beanList">
						  	  <li style="margin-bottom: 30px">
						  	  <s:url value="/spot-getScenicSpot.action" var="getBlogById">
						  	      <s:param name="id"><s:property value="#scenic.id"/></s:param>
						  	  </s:url>
							  	<span class="date"><a href='<s:property value="#getBlogById"/>'><s:date name="#scenic.releaseDate" format="yyyy/MM/dd HH:mm:ss"/></a></span>
							  	<span class="title"><a href="<s:property value="#getBlogById"/>"><s:property value="#scenic.name"/></a></span>
							  	<span class="summary">摘要: <s:property value="#scenic.intro"/></span>
							  	<%-- <span class="img">
							  	...
							  	<span class="info">发表于 <s:date name="#scenic.releaseDate" format="yyyy/MM/dd HH:mm:ss"/> 电话：${scenic.tel} 地址：${scenic.address} </span>
							  </li>
	...
	<script type="text/javascript">
		...
		$('#pageLimit').bootstrapPaginator({
	         currentPage: <s:property value="#session.scenicPageBean.pageCode"/>,//当前的请求页面。
	         totalPages: <s:property value="#session.scenicPageBean.totalPage"/>,//一共多少页。
	         size:"large",//应该是页眉的大小。
